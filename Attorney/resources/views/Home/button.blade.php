<ul class="slides">
    <li>
        <a href="centre"  class="icon"><img src="{{URL::asset('/imgs/images/icons/icon_about.png')}}"  alt="" title="" border="0" /><span>个人中心</span></a>
        ...
        <a href="legal_index"  class="icon"><img src="{{URL::asset('/imgs/images/icons/icon_portfolio.png')}}"  alt="" title="" border="0" /><span>法律常识</span></a>
    </li>
    <li>
        <a href="contribute"  class="icon"><img src="{{URL::asset('/imgs/images/icons/icon_photos.png')}}"  alt="" title="" border="0" /><span>律师投稿</span></a>

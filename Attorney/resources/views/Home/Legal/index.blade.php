                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="slide-inner">
                            <div class="logo"><a href="#"><img src="{{URL::asset('./age/colors/wedding/images/logo.png')}}" alt="" title="" border="0" /><span>知法&amp;守法</span></a></div>
                            <div class="menu">
                                <ul>
                                    @foreach($kind as $v)
                                    <li><a href="{{url('legal_list')}}?k_id={{$v->k_id}}" ><img src="{{URL::asset($v->k_img)}}" alt="" title="" style="width: 71px;height: 69px;"/><span>{{$v->k_name}}</span></a></li>
                                    @endforeach
                                </ul>
